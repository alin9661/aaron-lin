        ...
        <FadeIn key={hobby.id} delay={idx * 50} className="h-full">
          <div className="group relative overflow-hidden border border-zinc-200 bg-white h-full">
            ...
            <img
              src={hobby.image}
              alt={hobby.title}
              className="w-full h-full object-cover grayscale-[80%] transition-all duration-700 ease-out group-hover:scale-110 group-hover:grayscale-[40%] group-hover:brightness-110"
            />

            {/* Hover Overlay */}
            <div className="absolute inset-0 bg-zinc-950/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-6">
